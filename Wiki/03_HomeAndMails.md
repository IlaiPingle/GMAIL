...
**Optional**
- **Cc / Bcc**
- **Attachments**: images or files (`.png`, `.jpg`, `.pdf`, etc.)
...
- Receive **new mail notifications** when the app is in the background.
- Tapping a notification opens the relevant **thread**.
- You can mute specific labels or disable notifications from system settings.

**Notifications - Android**
![Notifications - Android](./images/gmail-notifications-android.png)
