...
public final class PersistentCookieJar implements CookieJar {
    ...
    private static final String K_VALUE = "token_value", K_DOMAIN = "token_domain",
            K_PATH = "token_path", K_EXPIRES = "token_expires",
            K_SECURE = "token_secure", K_HOSTONLY = "token_hostOnly";
    ...
    public synchronized List<Cookie> loadForRequest(@NonNull HttpUrl url) {
        ...
        boolean domainOk = c.hostOnly()
                ? url.host().equalsIgnoreCase(c.domain())
    ...
    private Cookie read() {
        ...
        if (hostO) b.hostOnlyDomain(domain);
