package com.example.MyGmail.data.repository;
...
import com.example.MyGmail.data.remote.net.MailAPIClient;
import com.example.MyGmail.data.remote.net.Resource;
import com.example.MyGmail.util.ApiErrorParser;
import com.example.MyGmail.util.UrlUtils;
