package com.example.MyGmail.data.local.db;
...
import com.example.MyGmail.data.local.dao.LabelDao;
import com.example.MyGmail.data.local.dao.MailDao;
import com.example.MyGmail.data.local.dao.UserDao;
 ...
 */
@Database(entities = {Mail.class, User.class, Label.class}, version = 9, exportSchema = false)
